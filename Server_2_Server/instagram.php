<?php
	...
	$sql = "SELECT token_access_token FROM tokens WHERE token_app_id = '" . "bfb2a65e4a8d434fb73953c1140da2e1" . "'";
	$result = $db->query($sql);

	$row = $result->fetch_assoc();

	$url = "https://api.instagram.com/v1/users/self/feed?access_token=" . $row['token_access_token'];
	...
	//var_dump($data['data']);
	//echo $feed;
//var_dump(json_decode($feed,true));
	update_database($db,"Instagram",$data['data']);
